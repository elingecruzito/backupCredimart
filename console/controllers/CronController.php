...
class CronController extends Controller {
    ...
    /* php  yii cron/cerrar-prestamos */
    public function actionCerrarPrestamos(){
    ...
    /* php  yii cron/crear-notificaciones */
    public function actionCrearNotificaciones(){
        //Se obtiene la fecha actual
        $today = date('Y-m-d'); 
    ...
    public function actionSendReport(){
        ...
        $result = Yii::$app->mailer
            ...
            ->setSubject('Reporte del ' . date('d-m-Y') )
