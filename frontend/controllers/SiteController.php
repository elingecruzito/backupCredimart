...
use common\models\search\ReportePrestamosSearch;
...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new ReportePrestamosSearch();
    ...
    public function actionLogin()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->login()) {
            Yii::$app->session->setFlash('info', str_replace('{notificaciones}', Notificaciones::getTotalNuevas(Yii::$app->user->id), Yii::$app->params['msjLoginNotificaciones']));
    ...
    public function actionResetPassword($token)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate() && $model->resetPassword()) {
            Yii::$app->session->setFlash('success', Yii::$app->params['msjChangePassword']);
